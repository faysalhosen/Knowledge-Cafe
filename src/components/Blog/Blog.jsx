    ...
    <div className="space-y-3 mb-14 border-b-2 pb-4">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* bookmark button */}
          <button onClick={fatherHandleBookmark} className="text-xl" style={{color: bookmarkClick ? 'orange' : 'red'}}>
            <BsBookmarkCheck />
          </button>
        </div>
      </div>
      ...
      {/* mark as read button */}
      <button onClick={()=> handleMarkRead(blog)} className="text-sky-600 font-semibold underline">
        Mark as read
      </button>
    </div>
  );
